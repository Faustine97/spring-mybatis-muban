...
<div style="float:right">
    <ul>
        ...
        <li><a href="user_edit.jsp">信息编辑</a></li>
        <li><a href="user_info.jsp">用户列表</a></li>
        <li><a href="message_create.jsp">留言</a></li>
    ...
    <table border="1" cellspacing="0">
        ...
        <form action="/message_board_spring_mybatis02/GuestbookListServlet" method="get">
            ...
            <tr>
                ...
                <td>
                    <c:if test="${book.user_id==sessionScope.user_edit.user_id}">
